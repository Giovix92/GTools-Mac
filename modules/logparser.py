...
def get_opencore_log_filename():
    '''What can distinguish the opencore log from the other files is the fact that it starts with opencore-xxxxxxxxxx.txt AND is a file. More validation can be added but to be fair i'm a little bit stoned rn'''
